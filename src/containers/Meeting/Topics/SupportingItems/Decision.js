...
const Decision = ({topicID, _id, description, meetingID, type, ownerID, update, canEdit, canDelete = true, onDeleteClick}) => {
            ...
            <div>
                {edit ? 
                    <Fragment>
                        ...
                        <SaveButton color="primary" isLoading={pending} onClick={editDecision} />
                    </Fragment>
                :
                    <Fragment>
                        <DecisionIcon className={classes.icon} /> {description}
                        <span>
...
export default connect(null, mapDispatchToProps)(Decision);