...
const Information = ({meetingID, topicID, _id, description, type, ownerID, update, canEdit, canDelete = true, onDeleteClick, ...props}) => {
            ...
            <div>
                {edit ? 
                    <Fragment>
                        ...
                        <SaveButton color="primary" isLoading={pending} onClick={editInformation} onClose={() => edit(false)} />
                    </Fragment>
                :
                    <Fragment>
                        <InformationIcon className={classes.icon} /> {description} 
                        <span>
