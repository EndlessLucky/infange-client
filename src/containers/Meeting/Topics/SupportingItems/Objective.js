...
const Objective = ({topicID, _id, description, meetingID, type, ownerID, update, canEdit, canDelete = true, onDeleteClick}) => {
            ...
            <div>
                {edit ? 
                    <Fragment>
                        ...
                        <SaveButton color="primary" isLoading={pending} onClick={editObjective} />
                    </Fragment>
                :
                    <Fragment>
                        <ObjectivesIcon className={classes.icon} /> {description}
                        <span>
